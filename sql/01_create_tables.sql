...
-- This script rebuilds the schema from scratch so repeated runs stay deterministic.
...
-- Store stations and connectors together by station_id to improve locality.
...
-- Partition the main transactional table by session date for time-based pruning.
...
-- Meter readings and maintenance tickets reference the transactional tables above.
