...
-- Purpose: Create analytical views that satisfy the complex query requirements.
-- Notes: View 1 targets partitioned sessions; View 2 uses subqueries and HAVING.
